...
| 阶段 | 周期 | 核心内容 | 里程碑 |
| :--- | :--- | :--- | :--- |
| 基础 | 2-4 周 | 所有权、借用、生命周期、类型、模式匹配 | 每天用 cargo 写小练习 |
| 进阶 | 4-8 周 | 错误处理、泛型与 trait、集合与迭代器、测试 | 读 TRPL 完成每章练习 |
| 实战 | 2-3 月 | 异步、Web 服务、serde、FFI | 完成一个实战项目 |
| 持续 | 长期 | 读标准库源码、参与开源 | 用 clippy 保持代码质量 |
