...
本节按照布鲁姆教育目标分类学组织学习路径。本文主题为《程序结构与基本语法》，属于 JavaScript 模块，读者可以根据自身阶段选择阅读深度。
...
通过本节学习，读者应当能够把《程序结构与基本语法》纳入自己的知识网络，并与 JavaScript 模块的其他主题（原型链、事件循环、闭包、ES 规范）建立关联。

## 2. 历史动机与发展脉络

《程序结构与基本语法》是 JavaScript 领域的重要主题。要真正理解它，需要先了解它解决的问题与演进过程。
...
该示例来自原文《1.1 内部脚本 (Inline Script)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《1.2 外部文件 (External Script)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《1.3 现代模块 (ESM - ES Modules)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《1.4 脚本加载顺序》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《2.1 语句 (Statements)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《2.2 注释 (Comments)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《3.1 var》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《3.2 let》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《3.3 const》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《3.4 变量提升 (Hoisting)》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《4.2 命名约定》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《5.1 开启严格模式》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《5.2 严格模式的限制》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《6.1 缩进》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《6.2 空格》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《6.3 换行》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《6.4 分号》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《6.5 引号》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《7.1 变量作用域错误》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《7.2 变量提升错误》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《7.3 严格模式错误》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《7.4 命名错误》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《8.1 模块化开发》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《8.2 严格模式应用》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《语句与分号》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《严格模式》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《注释》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《输出》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《标识符命名》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《输入》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
该示例来自原文《代码块》小节，用于演示程序结构与基本语法相关操作。阅读时请先看代码结构，再看其后的讲解。
...
- 1. 引入方式 (Inclusion)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 2. 语句与注释 (Statements & Comments)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 3. 变量声明 (Variable Declarations)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 4. 标识符规范 (Identifiers)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 5. 严格模式 (Strict Mode)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 6. 代码风格 (Code Style)：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 7. 常见错误与解决方案：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 8. 实战示例：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 9. 总结：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 语句与分号：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 严格模式：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 注释：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 输出：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 标识符命名：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 输入：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
- 代码块：该小节围绕程序结构与基本语法展开具体细节，阅读时应关注其与核心结论的对应关系；每个小节都是核心结论在某一个侧面的展开。
...
本文属于 JavaScript 模块。为了把《程序结构与基本语法》放入完整的知识网络，下面列出本模块的全部主题并给出相互关联的导读。学习时建议按模块内顺序推进，并在每个文档中留意交叉引用。
...
下表整理《程序结构与基本语法》及 JavaScript 模块中出现的高频术语，给出简明释义。术语按字母序或逻辑序排列，供查阅。
