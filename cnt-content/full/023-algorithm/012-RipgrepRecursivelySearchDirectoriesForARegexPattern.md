...
本章节提供 10 道习题的完整正文与详细解答，覆盖填空、选择、代码修正、开放性论述四类题型，按 Bloom 认知层级递进。

### 填空题知识点讲解

## 知识讲解与要点分析（原习题 1（ex-str-fb-01，记忆级））

**题目**：KMP 算法的预处理阶段构造前缀函数 π，其中 π[i] 定义为模式串 P[0..i] 中既是 ____ 又是 ____ 的最长真子串长度。KMP 主循环的时间复杂度为 ____。

**解析讲解**：真前缀 / 后缀 / $O(n)$（或 $O(n+m)$）
...
## 知识讲解与要点分析（原习题 2（ex-str-fb-02，理解级））
...
## 知识讲解与要点分析（原习题 3（ex-str-fb-03，应用级））
...
## 知识讲解与要点分析（原习题 4（ex-str-ch-01，分析级））
...
## 知识讲解与要点分析（原习题 5（ex-str-ch-02，分析级））
...
## 知识讲解与要点分析（原习题 6（ex-str-ch-03，评价级））
...
## 知识讲解与要点分析（原习题 7（ex-str-cf-01，应用级））
...
## 知识讲解与要点分析（原习题 8（ex-str-cf-02，应用级））
...
## 知识讲解与要点分析（原习题 9（ex-str-oe-01，评价级））
...
## 知识讲解与要点分析（原习题 10（ex-str-oe-02，创造级））
