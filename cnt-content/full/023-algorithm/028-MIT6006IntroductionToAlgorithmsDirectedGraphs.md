...
- type: journal
  ...
  pagesNote: The original paper by Arthur B. Kahn at Computer Usage Company, Inc. Introduced the in-degree based topological sorting algorithm now known as Kahn algorithm. Motivated by PERT-style project scheduling networks. The paper analyzed the algorithm for large-scale networks used in the POLYMER-PLANET system
- type: journal
  authors:
  - Tarjan, Robert Endre
  year: 1972
  ...
  pages: 146-160
  doi: 10.1137/0201010
  pagesNote: Tarjan seminal paper introducing linear-time algorithms for topological sorting (via DFS postorder reversal), strongly connected components, and biconnected components. Tarjan received the 1986 Turing Award partly for this work
- type: book
  authors:
  - Knuth, Donald E.
  year: 1997
...
- type: journal
  ...
  pagesNote: Original paper introducing PERT (Program Evaluation and Review Technique) developed for U.S. Navy Polaris submarine program in 1958. PERT extends CPM with probabilistic activity durations and uses topological order for forward-backward pass computation
- type: journal
  authors:
  - Aho, Alfred V.
  - Garey, Michael R.
  ...
  pages: 131-137
  doi: 10.1137/0201008
  pagesNote: Introduced transitive reduction of DAGs in linear time using topological sort. For DAG G, the transitive reduction is the unique smallest subgraph with the same transitive closure
- type: journal
  authors:
  - Tarjan, Robert Endre
  year: 1972
