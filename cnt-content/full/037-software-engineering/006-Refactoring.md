...
- 重构的安全性保障，见本模块《软件测试方法》
- 重构效果的度量，见本模块《软件度量》
- 代码审查中的重构建议，见 039-engineering-practices《代码审查清单》

> **一句话记忆**：重构是"不改变功能、只改善结构"的整理房间——坏味道（重复代码/过长方法）是"该扫了"的信号，提取方法/多态替代是常用扫帚，而**测试是安全网**：小步重构、每步验证、测试通过才继续。
