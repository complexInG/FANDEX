...
- 敏捷开发实践，见本模块《敏捷开发》
- 软件质量属性详解，见 038-software-architecture《质量属性》
- 工程化实践，见 039-engineering-practices《工程实践概述》

> **一句话记忆**：软件工程是"软件世界的造桥方法论"——用系统化、规范化、可度量的流程，把不可控的软件开发变成可控的工程过程；它不是写文档，而是用流程和度量控制风险。
