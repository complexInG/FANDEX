...
- 债务的偿还手段，见本模块《代码重构》
- 债务的预防（测试），见本模块《软件测试方法》
- 债务的工程化预防，见 039-engineering-practices《工程实践概述》

> **一句话记忆**：技术债务是"用质量换速度"的信用卡——谨慎欠债合理、鲁莽欠债危险、欠了不还最致命；还债要**排进 Backlog、按 ROI 优先、每 Sprint 留预算渐进偿还**，并用"童子军规则"让代码越改越干净。
