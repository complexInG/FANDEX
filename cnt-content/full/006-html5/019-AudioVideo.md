...
- 完整控制：`html5/011-HTML5MultimediaCanvasDrawing` 中自定义播放器与媒体 API；
- 音频进阶：Web Audio API 节点图与音频可视化；
- 性能：`html5/036-CriticalRenderingPathAndResourceLoading` 媒体预加载策略；
- 无障碍：`html5/009-Accessibility` 中媒体替代文本与字幕规范；
- 直播流：`html5/029-WebSocket` 与 MSE（Media Source Extensions）。
