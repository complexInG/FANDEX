...
- 离线场景：`html5/027-ServiceWorkerPWA` 中 Service Worker（Worker 家族的一员）；
- 数据缓存：`html5/013-HTML5OfflineStorageWebAPI` 中 Worker 与 IndexedDB 的配合；
