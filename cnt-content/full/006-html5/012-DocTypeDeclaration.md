...
related:
  ...
  - 'html5/013-HTML5OfflineStorageWebAPI'
...
- 元数据：`html5/014-MetadataCharacterEncoding` 学习 charset 与编码声明优先级；
- 渲染原理：`html5/036-CriticalRenderingPathAndResourceLoading` 理解解析与渲染流程；
- 废弃标签：`html5/038-HTML5ObsoleteTags` 考古 font/center/frameset 等老标签与现代替代方案；
