...
updated: '2026-08-03'
related:
  - 'html5/021-EmbeddedContent'
  - 'html5/022-ProgressMeter'
  - 'html5/024-DragAPI'
  - 'html5/025-Geolocation'
prerequisites:
...
- 组件细节：`html5/021-EmbeddedContent` 对比 iframe 与 Web Components 的隔离方式；
- PWA 深化：`html5/027-ServiceWorkerPWA` 完整生命周期与缓存策略；
- 离线存储：`html5/013-HTML5OfflineStorageWebAPI` 本地存储与 Cache API；
- 推送通知：`html5/013-HTML5OfflineStorageWebAPI` 中 Notification API；
