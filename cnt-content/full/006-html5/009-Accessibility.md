...
- 组件模式：`html5/023-WebComponentsPWADevelopment` 中自定义元素如何内置无障碍；
- 表单无障碍：`html5/010-HTML5FormValidation` 的验证提示与 `aria-describedby` 结合；
- 语义基础：先掌握 `html5/008-SemanticTag`，再理解 ARIA 的补充角色；
