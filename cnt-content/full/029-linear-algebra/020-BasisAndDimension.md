...
- 线性无关、线性相关与线性表示的判定细节，见 019 线性相关性。
- 秩与零空间维数的关系（秩-零化度定理），见 010 矩阵的秩。
- 基础解系作为零空间的基，见 015 齐次线性方程组。
- 坐标变换的更多例题（含三维完整流程），见 021 坐标与坐标变换。
- 标准正交基与内积空间版本的正交基，见 022 内积与正交性、023 施密特正交化。
