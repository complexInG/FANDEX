...
- 质量属性的权衡核心（CAP），见本模块《CAP理论与最终一致性》
- 质量属性在具体架构中的体现，见本模块《微服务架构》《事件驱动架构》
- 质量属性在业务建模中的落地，见本模块《领域驱动设计》

> **一句话记忆**：质量属性是"系统做得怎么样"——性能、可用性、安全、可修改、可扩展、可观测；它们之间互相冲突、没有免费午餐，所以架构的核心是把质量需求写成"可测量的场景"，明确优先级，再在权衡中做出记录在案的决策。
