...
- 架构的质量衡量标准，见本模块《质量属性》《架构评估》
- 分布式架构的权衡，见本模块《CAP理论与最终一致性》
- 架构的落地方法（DDD），见本模块《领域驱动设计》
- 架构决策如何记录，见 039-engineering-practices《设计文档规范》

> **一句话记忆**：架构是"影响深远、难以逆转"的系统决策——它决定系统能走多远；架构师是"为系统长远质量负责的人"，他的武器是证据驱动的决策、清晰可见的文档、和持续演化的耐心。
