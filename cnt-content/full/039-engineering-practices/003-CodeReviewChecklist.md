...
- 评审中发现的设计问题如何记录，见本模块《设计文档规范》
- 测试体系（评审中的测试维度详解），见 036-software-testing 模块
- Git 协作与 PR 工作流，见 003-git、004-github 模块

> **一句话记忆**：代码评审不是"找茬"，而是"让每一次变更都比之前更好"——评审者批准"明显改善代码库"的变更，把完美主义留到未来，把机械问题交给 AI，把精力留给设计与逻辑。
