...
1. **盘点练习**：选择一个你熟悉的知识领域（课程、项目、工具），把你知道的"隐性知识"列出来，然后尝试把其中 3 条写成"别人也能看懂"的显性文档。

2. **文档体检**：找一个你常用但质量存疑的文档（团队 Wiki、开源项目文档、课程笔记），用第 2.3 节的标准（准确/可搜索/面向读者/精简/有主人）给它打分，并指出最需要改进的 2 点。

3. **设计知识库**：为一个 5 人的新团队设计 Wiki 结构（首页导航 + 目录划分），要求覆盖"新人/研发/值班"三个入口，并解释你的设计思路。

4. **闭环分析**：回想一次你"产生了经验但没沉淀"的场景（比如解决了一个难题但没写下来），分析断在闭环的哪个环节（产生/沉淀/检索/应用），以及下次如何改进。

## 9. 参考资源

- 彼得·圣吉《第五项修炼》（学习型组织）：https://en.wikipedia.org/wiki/The_Fifth_Discipline
- Diátaxis 文档框架（面向任务的文档结构）：https://diataxis.fr/
- Google 开发者文档风格指南：https://developers.google.com/style
- Obsidian 个人知识管理：https://obsidian.md/

## 10. 延伸阅读

- 复盘经验如何沉淀，见本模块《事故复盘方法论》
- 评审结论如何记录共享，见本模块《技术方案评审》
- 设计文档如何写入知识库，见本模块《设计文档规范》
- 知识管理工具与文档系统，见 031-devops 模块

> **一句话记忆**：知识管理的闭环是"产生 → 沉淀 → 检索 → 应用"，目标是把"存在人脑里的知识"变成"存在团队里的知识"——这样一个人走了，知识还在；任何新人来了，都能快速接上。
