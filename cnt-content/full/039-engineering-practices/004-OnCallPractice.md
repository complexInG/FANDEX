...
- 监控、SLO 与可观测性详解，见 031-devops 模块
- 系统可靠性设计（容错、降级、熔断），见 038-software-architecture 模块
- 告警数据平台与指标体系，见 034-cloud-computing 模块

> **一句话记忆**：好的 On-Call 制度 = 双人轮值（有人兜底）+ 告警上限（每班 ≤2 次）+ SLO 告警（只叫醒人处理真问题）+ Runbook（让新人也能处理老故障）+ 及时复盘（让系统越来越稳）。
