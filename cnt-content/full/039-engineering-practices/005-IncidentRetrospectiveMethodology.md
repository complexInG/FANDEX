...
- 复盘发现的问题如何跟踪解决，见本模块《技术方案评审》
- 复盘经验如何沉淀共享，见本模块《知识管理》
- 可靠性工程与 SLO 体系，见 031-devops 模块

> **一句话记忆**：复盘的三连问——"发生了什么"（时间线）、"为什么会发生"（5-Whys 根因）、"如何不再发生"（行动项闭环）——加上无指责文化这层底色，把每一次事故都变成团队的免疫力提升。
