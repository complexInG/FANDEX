...
related:
  ...
  - 'getting-started/034-EnvVerificationChecklist'
prerequisites:
...
2. **PATH 未包含目录**：把安装目录加入 PATH（见 `getting-started/009-EnvVarPath`）；
...
- 环境变量：`getting-started/009-EnvVarPath`；
- 验证清单：`getting-started/034-EnvVerificationChecklist`；
