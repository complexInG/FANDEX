...
updated: '2026-08-02'
related:
  - 'javascript/033-ClosureMemoryLeakOptimization'
...
下一步建议阅读 [闭包的内存泄露与优化](/FANDEX/javascript/033-ClosureMemoryLeakOptimization/) 与
[内存泄漏排查](/FANDEX/javascript/034-MemoryLeakTroubleshoot/) 实战篇。
...
- 泄漏排查：`javascript/034-MemoryLeakTroubleshoot`；
- 集合弱引用：`javascript/021-MapSetWeakMapWeakSet`。
