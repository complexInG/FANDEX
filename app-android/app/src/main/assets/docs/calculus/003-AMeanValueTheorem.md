...
读者应具备 ε-δ 极限语言、单变量函数连续性与可微性的基本概念（参见 函数与极限 与 导数与微分）。
...
1. 阅读 函数与极限 第 2、5、6 章（10 小时）
2. 阅读 导数与微分 第 2、4 章（8 小时）
3. 阅读本篇第 1、2、4 章（6 小时）
4. 完成本篇第 9.1、9.2 节习题（4 小时）
5. 阅读 定积分与应用 第 5 章积分中值定理（2 小时）
...
5. 阅读 实分析 中关于 Lebesgue 微分定理的内容（10 小时）
